...
return [
    ...
    'getInfo' => fn() => [
        'title' => E::ts('Appearance-modifier Petition Setting'),
        'title_plural' => E::ts('Appearance-modifier Petition Settings'),
        'description' => E::ts('This table contains settings for modified petitions'),
        'log' => false,
    ],
    'getFields' => fn() => [
        'id' => [
